...
- **Fix ALL compiler warnings** including Range.new deprecations.
- Keep PRs small and reviewable; include rationale and tests.
...
- Use ExVCR (Finch adapter) for HTTP stubbing
