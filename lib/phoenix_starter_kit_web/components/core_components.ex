defmodule PhoenixStarterKitWeb.CoreComponents do
  @moduledoc """
  ...
  attr :variant, :string, values: ~w(primary secondary tertiary danger)
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    <fieldset class="fieldset mb-2">
      <label>
        ...
        <span class="label">
          <input type="checkbox" id={@id} name={@name} value="true" checked={@checked} class={@class || "checkbox checkbox-sm"} {@rest} />{@label}
        </span>
      </label>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixStarterKitWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixStarterKitWeb.Gettext, "errors", msg, opts)
    end
  end
